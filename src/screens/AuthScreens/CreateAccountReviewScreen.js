...
class CreateAccountReviewScreen extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            officetelephone: Constants.officetelephone? Constants.officetelephone : '',
            company_logo_url: Constants.company_logo_url? Constants.company_logo_url: '',
            ...
            appid: Platform.OS === 'ios' ? 'com.openhouse.ecaptureinc' : 'com.openhouse',
            // com.ecaptureinc.open -- that is old App id
            spinner: false,
    ...
    componentDidMount() {
        ...
        console.log("CreateAccountReviewScreen", this.state.officetelephone, this.state.company_logo_url);
    ...
    showAlert() {
        if (this.props.createaccount.newaccountstatus === 200 && this.state.spinner === false) {
            ...
            Alert.alert(
                'Duplicate Account',
                'Unfortunately we are unable to process your request at this time. Please review your information and try again.',
                [
                    { text: 'OK', onPress: this.gosiginscreen },
                ],
            )
