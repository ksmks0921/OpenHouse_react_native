...
class SelectMLSScreen extends Component {
  ...
  searchMLSAccount = () => {
    ...
    if(this.state.select_item == null){
      Alert.alert(
        '',
        'Please Select MLS or Board of Realtors',
        [
          {
            text: 'OK',
            onPress: () => {
    ...
    } else if(this.state.mls_name.length <5){
      Alert.alert(
        '',
        "Please Enter Agent's Name or Email Address or Agent MLS's ID",
        [
          {
            text: 'OK',
            onPress: () => {
