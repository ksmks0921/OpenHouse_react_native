...
class PropertyViewAttendeesScreen extends React.Component {
        ...
        <View style={styles.itemview_a}>
          <View style={styles.itmeimgcontainer_a}>
            <Avatar
                ...
                size="medium"
                overlayContainerStyle={{ backgroundColor: '#ffffff', width: 50, height: 50, borderRadius: 25, borderWidth: 0.05, borderColor: '#808080' }}
                activeOpacity={0.7}
              />
  ...
  Change_BtnStyle = flag_style => {
    if (!flag_style) {
      //   alert('styletest');
      return {
        width: Dimensions.get('window').width * 0.48-7.5,
        height: 30,
