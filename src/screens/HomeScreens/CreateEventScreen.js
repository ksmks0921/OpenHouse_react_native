...
class CreateEventScreen extends Component {
    ...
    this.state = {
      accountnum:
        props.login.account && props.login.account.account_num
          ...
          : '',
      eventName: '',
      advertisingid: props.login.account && props.login.account.account_num
      ? props.login.account.advertising_id
      : '',
  ...
  _save = () => {
    const { eventName, eventDate, uniqueid, accountnum, advertisingid } = this.state;
    data = {
    ...
    if (eventName === '') {
      ...
      Alert.alert(
        'New Event',
        'The Event: ' + eventName + ' for ' + eventDate + ' was successfully created.',
        [
            {text: 'OK', onPress: () =>  [this.setState({spinner: true}), this.props.createevent(data)]},
        ],
        {cancelable: false},
    );
