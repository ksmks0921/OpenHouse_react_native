...
class SplashScreen extends Component {
  ...
  storeData = async () => {
    try {
      ...
      // saving error
      console.log("storeData for questions = ", Constants.checkArray);
  ...
  storeDeviceId = async () => {
    try {
      ...
      Constants.device_id = this.state.device_id;

      console.log("storeDeviceId = ", Constants.device_id);
    } catch (e) {
      // saving error
    }
  };
  ...
  getData = async () => {
    try {
      ...
      if (value !== null) {
        ...
        console.log('retrieve stored checkArray ', Constants.checkArray);

      } else {
        this.storeData();
        console.log('go to store checkArray ');
  ...
  getDeviceId = async () => {
    try {
      ...
      console.log(value);
      if (value !== null) {
        Constants.device_id = JSON.parse(value);
        // value previously stored
      } else {
        this.storeDeviceId();
        console.log('go to store device id ');
      }
    } catch (e) {
      // error reading value
