...
const Constants = {
  POST_BASE_API_URL: 'http://www.openhousemarketingsystem.com/application/v3/post.php',
  GET_BASE_API_URL: 'http://www.openhousemarketingsystem.com/application/v3/get.php',
  officetelephone: '',
  company_logo_url: '',
  device_id: '',
